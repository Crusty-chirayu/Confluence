    ...
    <div className="h-full overflow-y-auto">
      ...
      >
        ...
        <Section title="Privacy & data" description="You decide what happens to your conversations.">
          <label className="flex cursor-pointer items-start gap-3 rounded-[--r-md] border border-[--border] p-4 transition-colors hover:bg-[--bg-hover]">
            <input
              type="checkbox"
              checked={training}
        ...
        <Section title="Account">
          <div className="space-y-2">
            <button
              ...
              className="flex w-full items-center gap-3 rounded-[--r-md] border border-[--border] px-4 py-3 text-left transition-colors hover:bg-[--bg-hover]"
            >
...
function Section({
  ...
  return (
    <motion.section variants={riseIn} className="mb-8">
...
function InfoRow({
  ...
  return (
    <div className="flex items-start gap-3 rounded-[--r-md] bg-[--bg-subtle] p-3.5">
